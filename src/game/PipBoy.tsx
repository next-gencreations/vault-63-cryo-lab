    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          overflow: 'auto', position: 'relative', maxHeight: 380,
        }}>
          <div style={{
        ...
        {[[-8,-8],[648,-8],[-8,480],[648,480]].map(([x,y],i) => (
          <div key={i} style={{ position: 'absolute', left: x, top: y, width: 12, height: 12, borderRadius: '50%', background: '#1a2a1a', border: '1px solid #2a4a2a' }} />
        ))}
