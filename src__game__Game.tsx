...
function VaultGame() {
  ...
  useEffect(() => {
    const handler = (e: KeyboardEvent) => {
      ...
      if (e.code === 'KeyD' && isActive && !activeTerminal && !pipBoyOpen) {
        setDoomOpen(o => !o);
      }
      if (e.code === 'Escape') {
  ...
  return (
    <div style={{
      ...
      {/* Doom defence button — mobile and desktop */}
      {showHUD && (
        <button
          type="button"
          ...
          style={{
            ...
            fontWeight: 'bold',
            letterSpacing: 2,
            boxShadow: '0 0 18px rgba(255, 204, 51, 0.35)',
            pointerEvents: 'auto',
      ...
      <VaultDoomInvaders
        ...
        tradingData={trading}
        room={trading.vaultRoom || 'LAB FLOOR'}
      />
